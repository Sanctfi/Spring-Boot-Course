...
public class ContactController {
    ...
    @ApiResponse(responseCode = "200", description = "Successful retrieval all contacts", content = @Content(schema = @Schema(implementation = Contact.class)))
    ...
    @Operation(summary = "Retrieves a contact", description = "Provides a contact for the specified ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Submit a contact", description = "Adds a contact to the database")
    @ApiResponses(value = {
